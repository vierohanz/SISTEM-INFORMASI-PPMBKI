...
return new class extends Migration
{
    ...
    {
        Schema::create('komentar_event', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('id_parent')->references('id')->on('komentar_event')->cascadeOnUpdate()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('komentar_event');
    }
};
